...
# Checks if hopper on top of composter contains a vanilla-compostable item and, if not, runs function dnv.recyclecraft:compost/custom-composting/hopper_tick
...
execute unless score @s dnv.hopper_cd matches 2..7 run execute store result score @s dnv.c_item_found run function dnv.recyclecraft:compost/hopper_vanilla_composting_check
...
execute unless score @s dnv.hopper_cd matches 1..7 unless score @s dnv.c_item_found matches -1 unless entity @s[tag=dnv.vanilla-composting] run function dnv.recyclecraft:compost/custom-composting/hopper_tick
