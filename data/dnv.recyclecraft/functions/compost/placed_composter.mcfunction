...
execute anchored eyes positioned ^ ^ ^ run function dnv.recyclecraft:compost/find_placed_composter
...
execute if score @s dnv.comp_found matches ..-61 anchored eyes positioned ^ ^ ^1 run function dnv.recyclecraft:compost/find_placed_composter_wide
