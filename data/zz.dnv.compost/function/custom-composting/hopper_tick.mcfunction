...
execute if score @s dnv.comp.hopper_slot matches 0 run data modify entity @s equipment.mainhand set from block ~ ~1 ~ Items[{Slot:0b}]
...
execute if score @s dnv.comp.hopper_slot matches 1 run data modify entity @s equipment.mainhand set from block ~ ~1 ~ Items[{Slot:1b}]
...
execute if score @s dnv.comp.hopper_slot matches 2 run data modify entity @s equipment.mainhand set from block ~ ~1 ~ Items[{Slot:2b}]
...
execute if score @s dnv.comp.hopper_slot matches 3 run data modify entity @s equipment.mainhand set from block ~ ~1 ~ Items[{Slot:3b}]
...
execute if score @s dnv.comp.hopper_slot matches 4 run data modify entity @s equipment.mainhand set from block ~ ~1 ~ Items[{Slot:4b}]
